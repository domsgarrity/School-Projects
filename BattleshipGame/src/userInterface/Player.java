...
public class Player 
{
    ...
    //Custom constructor to create a player with username.
    ...
    // Initialize BattleShip Game Objects
    ...
    //Initialize game board for play
            ...
            {        
                for(int row = rowClick; row < (rowClick + getCurrentShipLength()); row++)
                {
                    if(getPlayMode() == Constants.HUMAN)
                        ...
                        buttonBoard[row][colClick].setBackground(null);
                }
            ...
            case Constants.HORIZONTAL:
            {
                for(int col = colClick; col < (colClick + getCurrentShipLength()); col++)
                {
                    if(getPlayMode() == Constants.HUMAN)                    
                        ...
                        buttonBoard[rowClick][col].setBackground(null);
                }
    ...
    public void setPlayMode(int playMode)
    {
        ...
        if(playMode == Constants.HUMAN)
        {
            playMode = Constants.HUMAN;
        }
        else if(playMode == Constants.COMPUTER)
        {
            playMode = Constants.COMPUTER;
        }
