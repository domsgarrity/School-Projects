...
{		
    ...
    {	
        ...
        computerComputer.setEnabled(true);
     ...
     // This creates the visual panels for play
    ...
    private void initObjects()
    {
        ...
        //set defaults for initial game selection assuming it is h v c
